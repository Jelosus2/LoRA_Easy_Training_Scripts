...
class Ui_network_ui(object):
    ...
    def retranslateUi(self, network_ui):
        ...
        self.algo_select.setItemText(3, QCoreApplication.translate("network_ui", u"GLoRA", None))
        self.algo_select.setItemText(4, QCoreApplication.translate("network_ui", u"LoHa", None))
        self.algo_select.setItemText(5, QCoreApplication.translate("network_ui", u"IA3", None))
        self.algo_select.setItemText(6, QCoreApplication.translate("network_ui", u"Lokr", None))
        self.algo_select.setItemText(7, QCoreApplication.translate("network_ui", u"DyLoRA", None))
        self.algo_select.setItemText(8, QCoreApplication.translate("network_ui", u"BOFT", None))
        self.algo_select.setItemText(9, QCoreApplication.translate("network_ui", u"Diag-OFT", None))
        self.algo_select.setItemText(10, QCoreApplication.translate("network_ui", u"Full", None))
